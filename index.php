      ...
      require('auth/db.php');
        ...
        $gender = mysqli_real_escape_string($con,$gender);
                ...
                if ( empty($username) OR empty($firstname) OR empty($lastname) OR empty($phoneno)  OR empty($age) OR empty($password) OR empty($gender) OR !filter_var($email, FILTER_VALIDATE_EMAIL)) {
                    ...
                    echo "<div align='center' class='formaa col-xs-12' style='margin-top: 0;color:#ccc; background-color:#23232390; border-radius:10px; top:-150px;'><h3 style='color:#ccc;'> <span style='font-size:80px; color:#FFC655'>&#9786;</span><br>Please fill every details for your registration.</h3><br/>Click here to <a style='color:#979b1b;' href='login.php'>Login</a></div>";
                    ...
                    if($rows>=1){
                        ...
                        echo "<div align='center' class='formaa col-xs-12' style='margin-top: 0;color:#ccc; background-color:#23232390; border-radius:10px; top:-150px;'><h3 style='color:#ccc;'> <span style='font-size:80px; color:#FFC655'>&#9786;</span><br>Username or email already exists.</h3><br/>Click here to <a style='color:#979b1b;' href='login.php'>Login</a></div>";
                    } else{
