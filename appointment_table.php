...
<html>
  ...
  <?php
               ...
               
                {
                    ...
                    echo "<div style='overflow-x:auto;'><table class='table table-sm table-dark table-responsive' style='margin-top:50px;overflow-x:auto;'>
                        <thead>
                            ...
                            <th scope='col'>Confirm Appointment</th>
                            </tr>
                        </thead>
                        <tbody>";
                        ...
                        echo "<td>" . $row['time'] . "</td>";
                        echo "<td><a href='admin.php' ><button class='btn btn-info' style='margin: 0 30%; height:30px; width:auto;'>Confirm</button></a></td>";
                        echo "</tr></tbody>";
                        }
                        echo "</table><br></div>";
                }
      ...
      <h1 class="title">Appointment Table</h1>
